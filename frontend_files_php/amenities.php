...
<div class="card">
    <div class="card-body">     
        ...
        <?php if($_SESSION['role']=='admin'){
          ...
          <div class="row addo pr-5" style="display:none;">
              <div class="col">
              <button class="btn ml-3 btn btn-outline-warning float-right"id="canbtn">Cancel</button>
              <button class="btn ml-3 btn btn-outline-primary float-right"id="newbtn">Add</button>
                  <input type="text" class="form-control float-left" id="newame" Placeholder="Add Input here">
              </div>
          </div>
          <hr><br>';
        }
