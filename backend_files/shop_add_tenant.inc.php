        ...
        if(mysqli_num_rows($result)>0){
            ...
            if(mysqli_num_rows($result)>0){
                              ...
                              if(in_array(strtolower($ext1),array("jpg","jpeg","png","pdf")) &&($size1<=100000000))
                {
                      ...
                      if(!is_dir("../ownerdoc/shoptenant/$shop_no_n"))
                      {
                        mkdir("../ownerdoc/shoptenant/$shop_no_n");
                      }
                      $filename1 = 'tenant-'.$d.'.'.$ext1;
                      $dest1 = '../ownerdoc/shoptenant/'.$shop_no_n.'/'.$filename1;
                ...
                if(mysqli_query($conn,$sql)){
                    ...
                    if(mysqli_query($conn,$query)){
                        ...
                        if(!is_dir('../forms/'.$shop_no_n)){

                            mkdir('../forms/'.$shop_no_n);
                        }
