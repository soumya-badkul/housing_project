...
<h2  style="color:teal;" class="mt-3">Records</h2><hr>
  ...
  <div id="result" style='display:none;margin:0px;' class="table-responsive border p-1 pr-3">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <?php 
              $seperator=",";
              $file_name='history/flat_owner.csv';
      ...
      $.ajax({
        ...
        success:function(data,status){
          ...
          for(var i=1;i<=9;i++){
            ...
            $('#emp12').text(ee[12]);
            $('#emp9').html('<center><img src="employee/emp_image/'+ee[9]+'" width="200px" height="200px"></center>');
...
function otherdoc(pp){
  if(pp){
  var path='./employee/other_doc/'+pp ;
  console.log(path);
...
//-------------------------------------------------------------------------------------------------------------
    ...
    function alltenantdetails(trownum,ttypo){
      ...
      $('.trownumtoprint').val(trownum);
        ...
        for (var i = 0; i < 13; i++) {
            var id ='#t'+i;
            if(m == 11){var path = "ownerdoc/flattenant/"+kk[0]+"/"+kk[m];}
    ...
    function getshopownerhistory(shop_no){
      ...
      $.ajax({
        ...
        success:function(data,status){
          ...
          $('#so14').text(ll[14]);
          $('#so12').html('<center><img src="ownerdoc/shopowner/'+ll[0]+'/'+ll[12]+'" width="200px" height="200px"></center>');
          $('#so13').html('<center><img src="ownerdoc/shopowner/'+ll[0]+'/'+ll[13]+'" width="200px" height="200px"></center>');
